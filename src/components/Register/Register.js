        ...
        <div className="everything">
          ...
          <div className="register-form">
            ...
            <div className="button">
              <button className="buttons" onClick={() => this.login()}>
                Login
              </button>
            </div>
            ...
            <div className="password-box">
              <input
                ...
                onChange={e => this.handleChange(e, "regPassword1")}
                placeholder="Password"
              />
              <input
                type="password"
                value={this.state.regPassword2}
                onChange={e => this.handleChange(e, "regPassword2")}
            ...
            <div className="button">
              <button className="buttons" onClick={() => this.register()}>
                Register
              </button>
            </div>
          </div>
